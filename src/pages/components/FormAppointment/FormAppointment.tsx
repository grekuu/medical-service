            ...
            <div className="form-left">
                ...
                <form>
                    ...
                    <div className="double-input">
                        ...
                        <input type="number" className="form-input" placeholder="Age" required />
                    </div>
                    <div className="double-input">
                        <input type="date" className="form-input" placeholder="Appointment Date" required />
                        <input type="time" className="form-input" placeholder="12:00 PM" required />
                    </div>
                    <textarea
