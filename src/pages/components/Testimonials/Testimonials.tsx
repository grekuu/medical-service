                ...
                >
                    ...
                    <div className="carousel-item">
                        <div className="carousel-left">
                            <p>
                                Why I say old chap that is spifing, cockup cheeky get stuffed mate haggle chinwag posh
                                jeffrey bevy sloshed James.
                            </p>
                        ...
                        <div className="carousel-right">
                            <img src="/img_medical_testimonial1.png" alt="person" loading="lazy" />
                        </div>
                    </div>
                    {/* Item 2 */}
                    <div className="carousel-item">
                        ...
                        <div className="carousel-right">
                            <img src="/img_medical_testimonial2.png" alt="person" loading="lazy" />
                        </div>
                    </div>
                    {/* Item 3 */}
                    <div className="carousel-item">
                        ...
                        <div className="carousel-right">
                            <img src="/img_medical_testimonial3.png" alt="person" loading="lazy" />
                        </div>
                    </div>
                </Carousel>
            </Container>
